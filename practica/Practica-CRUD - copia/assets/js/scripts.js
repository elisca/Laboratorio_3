...
window.addEventListener('click',(e)=>{
    ...
    if(idTr>=0){        
        ...
        rdoSexoF.checked=(trMetaData.sexo=="true"),
        rdoSexoM.checked=!(trMetaData.sexo=="true"),
        chkTatuajes.checked=(trMetaData.tatuajes=="true"),
        chkPiercings.checked=(trMetaData.piercings=="true"),
        chkOtros.checked=(trMetaData.otros=="true")        
    }
});
